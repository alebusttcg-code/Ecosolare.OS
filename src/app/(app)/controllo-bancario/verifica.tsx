  ...
  return (
    ...
    >
      <input
        ...
        className="w-52 max-w-full rounded-md border px-2 py-1.5 text-xs outline-none focus:border-eco-blue-400"
        style={{ background: 'rgba(5,10,20,0.6)', borderColor: 'var(--bordo)' }}
      />
      <button
        type="submit"
        disabled={inCorso}
        className="bottone-fantasma rounded-md border px-2.5 py-1.5 text-xs"
        style={{ borderColor: 'var(--bordo)' }}
      >
        {inCorso ? '…' : 'Salva'}
      </button>

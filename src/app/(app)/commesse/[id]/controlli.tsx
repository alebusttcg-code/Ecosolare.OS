...
function Selettore({
  ...
  return (
    <select
      ...
      className={`${larghezza} rounded-md border px-2 py-1 text-xs transition-colors duration-200 outline-none focus:border-eco-blue-400`}
      ...
      {chiedeMotivo ? (
        ...
        >
          <input
            ...
            className="w-48 rounded-md border px-2 py-1 text-xs outline-none focus:border-eco-blue-400"
            style={{ background: 'rgba(5,10,20,0.55)', borderColor: 'var(--bordo)' }}
          />
          <button
            type="submit"
            className="bottone-fantasma rounded-md border px-2 py-1 text-xs"

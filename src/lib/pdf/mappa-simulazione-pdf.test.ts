...
describe('mappaSimulazionePerPdf — etichette falda', () => {
  it('usa l’indice Solar (non la posizione in array)', () => {
    const sim = {
      ...
      detrazioneTermico: null,
      agevolazioni: {
        investimentoLordoCents: 1_000_000,
        investimentoFvLordoCents: 1_000_000,
        investimentoTermicoLordoCents: 0,
        detrazioneTotaleCents: 500_000,
        contoTermicoTotaleCents: 0,
        investimentoEffettivoCents: 500_000,
        investimentoFvEffettivoCents: 500_000,
        incentivoTermico: null,
      },
      parametriEconomici: {
        tassoScontoPct: 4,
        degradazioneProduzionePctAnno: 0.4,
      },
      economia: {
        ...
        creditoMensileCents: 0,
        risparmioMensileCents: 5_000,
        risparmioTermicoAnno1Cents: 0,
        beneficioAnnuoAnno1Cents: 60_000,

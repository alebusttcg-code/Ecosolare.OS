...
async function main(): Promise<void> {
  ...
  const opp = await db
    ...
    .values([
      ...
      { code: 'OPP-2026-0003', contactId: deangelis!.id, businessLine: 'colonnina', title: 'Colonnina di ricarica 7 kW', stage: 'qualificato', stageSince: giorni(-2), ownerId: commerciale!.id, sourceId: fonte('cliente_esistente'), estimatedValue: '2400.00', probability: 20, nextActionDueAt: giorni(2), firstResponseAt: giorni(-4), createdAt: giorni(-5) },
